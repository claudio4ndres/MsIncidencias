...
/* build-hook-start *//*00001*/try { require('/Users/soaint/.vscode/extensions/wallabyjs.console-ninja-1.0.458/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20e968db80a21f298d9510VAkYDEpbAlJZAQZeBAkPAg4CBghW', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/soaint/.vscode/extensions/wallabyjs.console-ninja-1.0.458/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20e968db80a21f298d9510VAkYDEpbAlJZAQZeBAkPAg4CBghW', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
