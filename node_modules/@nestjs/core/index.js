"use strict";
/* build-hook-start *//*00001*/try { require('/Users/soaint/.vscode/extensions/wallabyjs.console-ninja-1.0.458/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '201906a033c92fa1e9757fAAkeAk8JCVBXAFFQAgRcWANTD1ZT', mode: 'runtime'}); } catch(cjsError) { try { import('file:///Users/soaint/.vscode/extensions/wallabyjs.console-ninja-1.0.458/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '201906a033c92fa1e9757fAAkeAk8JCVBXAFFQAgRcWANTD1ZT', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
